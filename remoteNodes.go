...
const urlRemoteNodes = "https://raw.githubusercontent.com/lithyriolu/conceal-nodes-json/master/conceal-nodes.json"
...
func requestListRemoteNodes() (remoteNodes []node) {
	...
	theNodes := new(nodes)
	err := getJSONFromHTTPRequest(urlRemoteNodes, theNodes)
